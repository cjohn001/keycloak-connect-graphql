...
type KeycloakConnectStatic = new (options: KeycloakConnect.KeycloakOptions, config: KeycloakConnect.KeycloakConfig) => KeycloakConnect.Keycloak;
...
declare namespace KeycloakConnect {
    ...
    interface GrantManager {
         ...
         * @param {String} sessionHost Optional session host for targeted Keycloak console post-backs.
         * @param callback
         */
         ...
         *
         * @param data {String|GrantProperties} rawData The raw JSON string received from the Keycloak server or from a client.
